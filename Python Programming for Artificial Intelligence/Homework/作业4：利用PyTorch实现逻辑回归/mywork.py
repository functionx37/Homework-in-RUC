...
class Logistics_Model():
    ...
    def __init__(self, in_dim):
        ...
        *********请在此处输入你的代码*********
        ...
        self.optimizer = torch.optim.SGD(self.model.parameters(), lr = self.learing_rate)
    ...
    def test(self, x, y):
        ...
        for i in range(prediction.shape[0]):
            if (prediction[i] < 0.5 and y[i] == 0) or (prediction[i] >= 0.5 and y[i] == 1):
                cnt += 1
        accurancy = cnt/prediction.shape[0]
        return prediction, accurancy
